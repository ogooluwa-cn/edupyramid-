  ...
  const signUpMutation = useMutation({
    mutationFn: async () => {
      ...
      const res = await fetch('https://ogo-server.onrender.com/sign-up', {
        ...
        body: JSON.stringify({ email, username, password, phoneNumber: countryCode + phoneNumber }),
      })
    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-blue-50 to-white px-6 sm:px-8 lg:px-10 animate__animated animate__fadeIn">
      <div className="bg-white p-10 rounded-xl shadow-lg max-w-lg w-full">
        ...
        <form className="space-y-8" onSubmit={handleSubmit}>
          {/* Name group */}
          <section>
            <h2 className="text-xl font-semibold text-blue-800 mb-4 border-b border-blue-100 pb-2">
              Personal Information
            </h2>
            <div className="space-y-4">
              <div>
                <label htmlFor="surname" className="block text-sm font-medium text-blue-900 mb-1">
                  Surname
                </label>
                <input
                  id="surname"
              ...
              <div>
                <label htmlFor="middleName" className="block text-sm font-medium text-blue-900 mb-1">
                  Middle Name
                </label>
                <input
                  id="middleName"
          ...
          <section>
            ...
            <div className="space-y-4">
              <div>
                <label htmlFor="country" className="block text-sm font-medium text-blue-900 mb-1">
                  Country
                </label>
                <select
                  id="country"
